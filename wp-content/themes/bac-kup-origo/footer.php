...
<?php if (!function_exists('bac_kup_is_global_part_page') || !bac_kup_is_global_part_page()) : ?>
    <?php $rendered_global_footer = function_exists('bac_kup_render_global_part') && bac_kup_render_global_part('footer'); ?>
    <?php if (!$rendered_global_footer) : ?>
<footer>
  <div class="footer-wrap">
    <div class="footer-grid">
      <div>
        <a href="<?php echo esc_url(home_url('/')); ?>" class="footer-logo-link" aria-label="Bac-kup home">
          <img src="<?php echo esc_url(function_exists('bac_kup_logo_url') ? bac_kup_logo_url() : home_url('/logo.png')); ?>" alt="Bac-kup" class="footer-logo-img">
        </a>
    ...
    <div class="footer-bottom">
      <span class="ftr-copy">&copy; <?php echo esc_html(wp_date('Y')); ?> Bac-kup B.V. - Anne Frankstraat 35, 2548LA 's-Gravenhage - KvK 99878232</span>
